...
content = content.replace("export default function ModuleGippDocs() {", "function TextEditor() {")
...
# We also need to change setView('sheets_editor') in TextEditor's handleOpenFile if it exists.
content = content.replace("setView('sheets_editor');", "")
