...
export const PORTAL_MODULES = [
    ...
    { id: 'portal_candidato', label: 'Área do Candidato (Formação Ministerial)', desc: 'Espaço de estudo para obreiros e candidatos: apostilas doutrinárias CGADB/CPAD (5 graus x 5 módulos x 5 páginas), envio de ensaios, estágio e mentoria.', iconId: 'Award' },
