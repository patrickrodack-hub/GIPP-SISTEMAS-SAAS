        ...
        <div className="space-y-8">
            ...
            <div className="relative pl-8 border-l-2 border-indigo-500 animate-entrance"> 
                ...
                <ul className="list-disc pl-4 space-y-2 text-slate-600 text-sm">
                    ...
                    <li><strong className="text-slate-700 font-sans font-extrabold">GIPP DOCs:</strong> Novo editor de texto avançado no Estúdio Canva, com estilo Google Docs e Word, suporte a formatação rica, salvamento local de arquivos .gdoc e leitura de documentos no computador.</li>
                    <li><strong className="text-slate-700 font-sans font-extrabold">GIPP Planilhas:</strong> Novo editor de planilhas de alta performance no Estúdio Canva, compatível com as fórmulas e experiência do Google Sheets e Microsoft Excel. Suporta múltiplas abas, barra de fórmulas e salvamento no formato .gplan.</li>
