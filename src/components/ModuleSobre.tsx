    ...
    return (
        <div className="glass-modern p-10 rounded-[2.5rem] animate-entrance max-w-5xl mx-auto space-y-10">
            <div className="text-center">
                ...
                <p className="text-indigo-600 font-black tracking-widest uppercase text-sm bg-indigo-50 px-4 py-2.5 rounded-full inline-block border border-indigo-200/50 shadow-xs">{db.igreja?.saas_versao_sistema || "Versão 9.5.0 Ultimate Platinum v14"}</p>
            </div>
