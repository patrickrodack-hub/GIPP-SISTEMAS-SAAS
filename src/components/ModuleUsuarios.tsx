...
const CATEGORIAS_PERMISSOES = [
  ...
  },
  {
    ...
    opcoes: [
      ...
      { id: 'access_revistas_interativas', label: 'Revistas Interativas IA (Estudo EBD)' },
...
const ModuleUsuarios = memo(() => {
  ...
  const handleFuncaoChange = (val: string) => {
    ...
    if (val === 'PASTOR PRESIDENTE' || val === 'PASTOR AUXILIAR') {
      ...
      perms = ['access_membros', 'access_visitantes', 'access_igreja', 'access_celulas', 'access_sec_agenda', 'access_sec_certificados', 'access_ebd', 'access_revistas_interativas', 'access_salinha_kids', 'access_gestao_cursos', 'access_boletim', 'access_sec_relatorios', 'access_manual', 'access_amparo_legal', 'access_registro_software', 'access_interativo'];
      ...
      perms = ['access_sec_agenda', 'access_ebd', 'access_revistas_interativas', 'access_gestao_cursos', 'access_manual', 'access_interativo'];
    }
