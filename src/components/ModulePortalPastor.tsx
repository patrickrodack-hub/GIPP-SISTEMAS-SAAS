...
import {
  Calendar, Plus, Trash2, Edit2, Play, Users, DollarSign, BookOpen, Clock, Layers,
  FileText, Shield, Sparkles, Send, Headset, Trash, Check, X, AlertCircle, FileSpreadsheet,
  Search, ChevronRight, UserCheck, Heart, UserMinus, Eye, Filter, ArrowUpRight, ArrowDownLeft,
  Percent, TrendingUp, Printer, Download, Image, CheckCircle, HelpCircle, Briefcase, ChevronDown,
  BookOpenText, Target, MapPin, Edit, Loader2, TrendingDown, Landmark, AlertTriangle, HeartHandshake,
  Zap, RefreshCw, List
} from 'lucide-react';
